class GetMealsByCategoryResponse {
  final List<Meal> meals;

  GetMealsByCategoryResponse({required this.meals});

  factory GetMealsByCategoryResponse.fromJson(Map<String, dynamic> json) =>
      GetMealsByCategoryResponse(
